...
Ps2Kbd_Mrmltr::Ps2Kbd_Mrmltr(PIO pio, uint base_gpio,
...
inline static uint8_t hidKeyToMod(uint8_t hidKeyCode) {
    ...
    switch (hidKeyCode) {
        case HID_KEY_CONTROL_LEFT:
            m = KEYBOARD_MODIFIER_LEFTCTRL;
            break;
        case HID_KEY_SHIFT_LEFT:
            m = KEYBOARD_MODIFIER_LEFTSHIFT;
            break;
        case HID_KEY_ALT_LEFT:
            m = KEYBOARD_MODIFIER_LEFTALT;
            break;
        case HID_KEY_GUI_LEFT:
            m = KEYBOARD_MODIFIER_LEFTGUI;
            break;
        case HID_KEY_CONTROL_RIGHT:
            m = KEYBOARD_MODIFIER_RIGHTCTRL;
            break;
        case HID_KEY_SHIFT_RIGHT:
            m = KEYBOARD_MODIFIER_RIGHTSHIFT;
            break;
        case HID_KEY_ALT_RIGHT:
            m = KEYBOARD_MODIFIER_RIGHTALT;
            break;
        case HID_KEY_GUI_RIGHT:
            m = KEYBOARD_MODIFIER_RIGHTGUI;
            break;
        default:
            break;
    }
